$(function () {
    ...
    $("#topNav .titleText").click(function () {
        ...
        $(this).children("a").children("#icon1").attr("src", "./imges/icon1s.png");
        $(this).children("a").children("#icon2").attr("src", "./imges/icon2s.png");
        $(this).children("a").children("#icon3").attr("src", "./imges/icon3s.png");
        $(this).children("a").children("#icon4").attr("src", "./imges/icon4s.png");
